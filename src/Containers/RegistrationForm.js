      ...
      <Container style={{ marginTop: '30px' }}>
        ...
        <div className="input">
          ...
          <TextField
            ...
            placeholder="Enter Owner's P Number"
            fullWidth
        ...
        <div className="input">
          <TextField
            ...
            type="address"
            label="Address"
            placeholder="Enter Land's Location"
            fullWidth
          ...
          <TextField
            ...
            placeholder="Enter Area on square meters"
            fullWidth
          ...
          <label for="file">Upload an image of Land</label>
          <br />
          <form>
            <input
              ref="file"
